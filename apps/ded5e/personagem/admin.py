...
class ListandoMagias(admin.ModelAdmin):
    list_display = ('id','nome', 'nivel' ,'personagem')
    list_display_links = ('id','nome', 'nivel', 'personagem')

admin.site.register(MagiasPersonagem,ListandoMagias)